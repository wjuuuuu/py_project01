...
# 选修法语学生名单
french_set={"江许木", "王卓", "十三", "虎咆", "姜老道", "天运子", "红蝶", "厉飞雨", "韩立", "曾牛"}
# 选修艺术学生名单
...
print(f"选修了足球但是没有选修篮球的学生：{fb_set}")

# 方式二： - ---> 差集
fb_set2 = football_set - basketball_set
print(f"选修了足球但是没有选修篮球的学生：{fb_set2}")

# 方式三： 集合推导式 ---> 快速构筑集合（要往集合中添加的数据 for s in set1 if 条件）
fb_set3 = {s for s in football_set if s not in basketball_set}
print(f"选修了足球但是没有选修篮球的学生：{fb_set3}")
